...
Evidence: Validation output will be recorded in `Artifacts and Notes` and in `docs/execution/progress/HARNESS-IMPLEMENTATION-PROGRESS.md`.
...
Revert the harness runtime module and workflow changes together if validation exposes regressions. Remove `docs/execution/plans/HARNESS-IMPLEMENTATION-PLAN.md` and `docs/execution/progress/HARNESS-IMPLEMENTATION-PROGRESS.md` only if the implementation is abandoned.
