...
<#
.SYNOPSIS
 Install AgentX v8.4.9 - Download, copy, configure.
...
Write-Host "| AgentX v8.4.9 - AI Agent Orchestration |" -ForegroundColor Cyan
Write-Host "+===================================================+" -ForegroundColor Cyan
Write-Host ""
...
if ($previousVersion -and $previousVersion -ne "8.4.9") {
 $majorVersion = 0
 try { $majorVersion = [int]($previousVersion -split '\.')[0] } catch {}

 if ($majorVersion -lt 8) {
    Write-Host "[!] Detected AgentX v$previousVersion - upgrading to v8.4.9..." -ForegroundColor Yellow
...
Write-OK "Version 8.4.9 recorded"
...
Write-Host " AgentX v8.4.9 installed! [$displayMode]" -ForegroundColor Green
Write-Host "===================================================" -ForegroundColor Green
Write-Host ""
