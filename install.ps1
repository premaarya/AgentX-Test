...
<#
.SYNOPSIS
 Install AgentX v8.4.25 - Download, copy, configure.
...
Write-Host "| AgentX v8.4.25 - AI Agent Orchestration |" -ForegroundColor Cyan
Write-Host "+===================================================+" -ForegroundColor Cyan
Write-Host ""
...
Write-OK "Version 8.4.25 recorded"
...
Write-Host " AgentX v8.4.25 installed! [$displayMode]" -ForegroundColor Green
Write-Host "===================================================" -ForegroundColor Green
Write-Host ""
