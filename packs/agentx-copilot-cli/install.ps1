...
<#
.SYNOPSIS
 Install AgentX Copilot CLI Plugin v8.4.30 into a workspace.
...
Write-Host "| AgentX Copilot CLI Plugin v8.4.30        |" -ForegroundColor Cyan
...
Write-Host " AgentX Copilot CLI Plugin v8.4.30 installed" -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
